  	...
  	extend: {
  		...
  		keyframes: {
  			...
  			'wave-motion': {
  				...
  				'40%': { transform: 'translateX(-1px) translateY(0.8px)' },
  				'60%': { transform: 'translateX(1px) translateY(-0.6px)' },
  				'80%': { transform: 'translateX(-1.5px) translateY(0.4px)' },
  		...
  		animation: {
  			...
  			'wave-motion': 'wave-motion 1.5s ease-in-out infinite'
  		},
  		fontFamily: {
  			sans: [
  				'Space Grotesk',
